...
import aspect.common.extensions.PipingExtensions._
import aspect.rest.RestErrors._
import spray.json._
...
trait Jasonify extends Routes {
  ...
  implicit val jsonExceptionHandler: ExceptionHandler =
    ExceptionHandler {
  ...
  private def jasonifyException(exception: Throwable)(implicit settings: RoutingSettings): Route =
